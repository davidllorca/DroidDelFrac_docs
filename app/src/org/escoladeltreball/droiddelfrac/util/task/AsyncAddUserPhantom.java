...
/**
 * Realiza una llamada al servidor para inserta un usuario virtual en un evento determinado.
 * 
 ...
 */
public class AsyncAddUserPhantom extends AsyncTask<String, Void, Boolean> {

	private static final String TAG = "AsyncAddUserPhantom";
	private Context context;

	public AsyncAddUserPhantom(Context context) {
	...
	private Boolean handleResult(String result) {
		boolean insertPhantomDone = false;
