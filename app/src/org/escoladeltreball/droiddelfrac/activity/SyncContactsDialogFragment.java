 ...
 */
public class SyncContactsDialogFragment extends DialogFragment {
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		// Set Dialog Icon
				...
				// Set Dialog Message
				.setMessage(R.string.noContactsSync)
				// Positive button
				.setPositiveButton(R.string.syncronize, new DialogInterface.OnClickListener() {
